...
const Hero =() =>{
    return(
        <div className="w-[1920px] h-[829px] top-[92px] left-[1px] py-[140px] px-[220px] bg-[#043873] text-[#FFFFFF] flex sm:flex-col md:flex-row">
            <div className="w-[656px] sm:h-full md:h-[361px] ">
                ...
                <div className="w-[224px] h-[63px] rounded-lg p-5 gap-[10px] bg-[#4F9CF9] mt-4 flex justify-between sm: flex-col md:flex-row">
                   <p className="w-[159px] sm:h-full md:h-[23px] text-lg font-medium font-inter leading-[23px] tracking-[-2%] text-[#FFFFFF] ">Try Whitepace free</p>
