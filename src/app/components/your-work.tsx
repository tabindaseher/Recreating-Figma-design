...
const YourWork = () => {
    return(
        <div className="w-[1921px] h-[574px] top-[4080px] left-[1px] py-[140px] px-[220px] bg-[#043873] ">
            <div className="w-[1481px] h-[294px] gap-[60px] text-center ">
                ...
                <div className="w-[195px] h-[63px] rounded-lg py-5 px-10 gap-[10px] bg-[#4F9CF9] mt-10 absolute left-1/2 flex justify-center items-center">
