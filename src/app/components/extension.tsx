...
import icon2 from "@/app/assets/Landing page V1/desktop/Icon.png"
 ...
 const Customise = () => {
    return(
    <div className="w-[1921px] h-[759px] top-[2509px] left-[1px] px-[220px] py-[140px] gap-[98px] bg-[#043873] flex sm:flex-col md:flex-row">
        <div className="sm:w-[300px] md:w-[697px] sm:h-full md:h-[294px] gap-[60px] ">
            ...
            <div className="w-[171px] sm:h-full md:h-[63px] rounded-md py-5 px-10 gap-[10px] bg-[#4F9CF9] mt-6 flex sm:flex-col md:flex-row justify-center ">
